...
namespace LibZano
{
	...
	public class Library
	{
		...
		[DllImport(Library.kLibraryName, CallingConvention = Library.kCallingConvention, EntryPoint = "Zano_IsUploadingFirmware"), SuppressUnmanagedCodeSecurity]
		extern public static int IsUploadingFirmware(uint handle);


		[DllImport(Library.kLibraryName, CallingConvention = Library.kCallingConvention, EntryPoint = "Zano_GetFirmwareUploadProgress"), SuppressUnmanagedCodeSecurity]
		extern public static int GetFirmwareUploadProgress(uint handle);
	...
	public struct SerialNumber
	{
		...
		[DllImport(Library.kLibraryName, CallingConvention = Library.kCallingConvention, EntryPoint = "Zano_GetSerialNumber"), SuppressUnmanagedCodeSecurity]
		extern public static int GetSerialNumber(uint zano, ref SerialNumber out_serialNumber);
		...
		[DllImport(Library.kLibraryName, CallingConvention = Library.kCallingConvention, EntryPoint = "Zano_GetAccelOffsetConfiguration_MinX"), SuppressUnmanagedCodeSecurity]
		extern public static int GetAccelOffsetConfiguration_MinX(uint handle);


		[DllImport(Library.kLibraryName, CallingConvention = Library.kCallingConvention, EntryPoint = "Zano_GetAccelOffsetConfiguration_MinY"), SuppressUnmanagedCodeSecurity]
		extern public static int GetAccelOffsetConfiguration_MinY(uint handle);


		[DllImport(Library.kLibraryName, CallingConvention = Library.kCallingConvention, EntryPoint = "Zano_GetAccelOffsetConfiguration_MinZ"), SuppressUnmanagedCodeSecurity]
		extern public static int GetAccelOffsetConfiguration_MinZ(uint handle);


		[DllImport(Library.kLibraryName, CallingConvention = Library.kCallingConvention, EntryPoint = "Zano_GetAccelOffsetConfiguration_MaxX"), SuppressUnmanagedCodeSecurity]
		extern public static int GetAccelOffsetConfiguration_MaxX(uint handle);


		[DllImport(Library.kLibraryName, CallingConvention = Library.kCallingConvention, EntryPoint = "Zano_GetAccelOffsetConfiguration_MaxY"), SuppressUnmanagedCodeSecurity]
		extern public static int GetAccelOffsetConfiguration_MaxY(uint handle);


		[DllImport(Library.kLibraryName, CallingConvention = Library.kCallingConvention, EntryPoint = "Zano_GetAccelOffsetConfiguration_MaxZ"), SuppressUnmanagedCodeSecurity]
		extern public static int GetAccelOffsetConfiguration_MaxZ(uint handle);
		...
		public enum Status
		{
			...
			FirmwareConfigurationPersistanceSaveRequested     = 1101,
			FirmwareConfigurationPersistanceSaveCompleted     = 1102,
			FirmwareConfigurationPersistanceSaveFailure       = 1103
		}
	...
	public static class ServerConnectivity
	{
        ...
        [DllImport(Library.kLibraryName, CallingConvention = Library.kCallingConvention, EntryPoint = "Zano_ServerConnectivity_ForceRefresh"), SuppressUnmanagedCodeSecurity]
        extern public static void ForceRefresh();

        [DllImport(Library.kLibraryName, CallingConvention = Library.kCallingConvention, EntryPoint = "Zano_ServerConnectivity_Credentials_Name"), SuppressUnmanagedCodeSecurity]
		extern private static IntPtr _Name();
		...
		[DllImport(Library.kLibraryName, CallingConvention = Library.kCallingConvention, EntryPoint = "Zano_ServerConnectivity_Credentials_Clear"), SuppressUnmanagedCodeSecurity]
	...
	public static class Calibration
	{
		...
		[DllImport(Library.kLibraryName, CallingConvention = Library.kCallingConvention, EntryPoint = "Zano_SetCallibration"), SuppressUnmanagedCodeSecurity]
		extern public static int Set(ref Library.SerialNumber serialNumber, ref Frame out_frame);


		[DllImport(Library.kLibraryName, CallingConvention = Library.kCallingConvention, EntryPoint = "Zano_GetCallibration"), SuppressUnmanagedCodeSecurity]
		extern public static int Get(ref Library.SerialNumber serialNumber, uint symbol, ref Frame out_frame);


		[DllImport(Library.kLibraryName, CallingConvention = Library.kCallingConvention, EntryPoint = "Zano_ApplyCallibrationPersistance"), SuppressUnmanagedCodeSecurity]
		extern public static int ApplyToServer(ref Library.SerialNumber serialNumber, uint symbol);
